...
# probabilidade de sucesso é 50%.
# Ao passar 10 clientes em nossa loja, qual a probabilidade de realizarmos 2 
# vendas?
...
# esperada de vendas a cada dez clientes?
...
hist(va_binomial) # A maior barra no histograma representa a quantidade 
# esperada de vendas
#Ajuste o parametro n para 1000 e plote o histograma, observe como a 
...
#########################################
# Exemplo: Uma loja recebe em média, 6 (λ) clientes por minuto. Qual a probabilidade de
# que 5(x) clientes
#entrem em um minuto?
...
#normal com média μ=2.500 e desvio padrão σ= 170.
